...
namespace Tenebit.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260814161313_AddAlertRulesAndDigestSettings")]
    partial class AddAlertRulesAndDigestSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tenebit.Domain.Assets.AssetCategory", b =>
                {
                    ...
                    b.Property<bool>("VisibleInEmployeeCatalog")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Tenebit.Domain.Reservations.EquipmentKitDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("equipment_kit_definitions", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Reservations.EquipmentKitDefinitionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("equipment_kit_definition_items", "tenebit");
                });
            ...
            modelBuilder.Entity("Tenebit.Domain.Reservations.EquipmentKitDefinitionItem", b =>
                {
                    b.HasOne("Tenebit.Domain.Reservations.EquipmentKitDefinition", null)
                        .WithMany("Items")
