...
namespace Tenebit.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260925123355_AddAssignmentAssetReturnState")]
    partial class AddAssignmentAssetReturnState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tenebit.Domain.Affiliates.Affiliate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("MaxActiveCodesOverride")
                    ...
                    b.Property<string>("PayoutAccountTag")
                        .HasMaxLength(200)
                    ...
                    b.ToTable("affiliates", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateClick", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("AttributionToken")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AffiliateCodeId", "IpHash", "ClickedAt");

                    b.ToTable("affiliate_clicks", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("affiliate_codes", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateConversion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("AffiliatePayoutPeriodId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsWithinCommissionWindow")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("AffiliatePayoutPeriodId");

                    b.HasIndex("PaddleTransactionId")
                        .IsUnique();

                    b.ToTable("affiliate_conversions", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateCountryDiscountRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("affiliate_country_discount_rules", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateEmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("affiliate_email_verification_tokens", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("affiliate_messages", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateMessageThread", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("UnreadByAffiliate")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("affiliate_message_threads", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliatePasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("affiliate_password_reset_tokens", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliatePayout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<Guid>>("CoveredPeriodIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.Property<DateTimeOffset>("MarkedPaidAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("affiliate_payouts", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliatePayoutPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AffiliateId", "PeriodStart")
                        .IsUnique();

                    b.ToTable("affiliate_payout_periods", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateProgramSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("CodeGrantsCustomerDiscountByDefault")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int?>("DefaultCommissionWindowMonths")
                        .HasColumnType("integer");

                    b.Property<int?>("DefaultCustomerDiscountDurationMonths")
                        .HasColumnType("integer");

                    b.Property<decimal?>("DefaultCustomerDiscountPercent")
                        .HasColumnType("numeric(5,2)");

                    b.Property<int>("DefaultMaxCodesPerAffiliate")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PayoutGraceDays")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("affiliate_program_settings", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("affiliate_refresh_tokens", "tenebit");
                });
            ...
            modelBuilder.Entity("Tenebit.Domain.Assets.PublicReportThrottle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ReporterHash")
                        .IsRequired()
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("OrganizationId", "AssetId", "CreatedAt");

                    b.HasIndex("OrganizationId", "ReporterHash", "CreatedAt");

                    b.ToTable("public_report_throttle", "tenebit");
                });
            ...
            modelBuilder.Entity("Tenebit.Domain.Settings.RoleLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tenebit.Domain.Subscriptions.OrganizationSubscription", b =>
                {
                    ...
                    b.Property<int?>("PendingBillingInterval")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tenebit.Domain.Subscriptions.ProcessedPaddleEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("processed_paddle_events", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Subscriptions.PromoCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("promo_codes", "tenebit");
                });

            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateClick", b =>
                {
                    b.HasOne("Tenebit.Domain.Affiliates.AffiliateCode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateCode", b =>
                {
                    b.HasOne("Tenebit.Domain.Affiliates.Affiliate", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tenebit.Domain.Affiliates.AffiliateMessage", b =>
                {
                    b.HasOne("Tenebit.Domain.Affiliates.AffiliateMessageThread", null)
                        .WithMany()
                    ...
                    b.OwnsMany("Tenebit.Domain.Assignments.AssignmentAsset", "Assets", b1 =>
                        {
                            ...
                            b1.Property<string>("ReturnState")
                                .HasMaxLength(20)
                                .HasColumnType("character varying(20)");
