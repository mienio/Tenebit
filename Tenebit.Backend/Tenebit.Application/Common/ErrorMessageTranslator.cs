...
public static class ErrorMessageTranslator
{
    private static readonly Dictionary<string, (string En, string Es, string De)> Exact = new()
    {
        ...
        ["Link do resetu hasła jest nieprawidłowy lub wygasł."] = ("The password reset link is invalid or has expired.", "El enlace para restablecer la contraseña no es válido o ha caducado.", "Der Link zum Zurücksetzen des Passworts ist ungültig oder abgelaufen."),
        ["Link weryfikacyjny jest nieprawidłowy lub wygasł."] = ("The verification link is invalid or has expired.", "El enlace de verificación no es válido o ha caducado.", "Der Bestätigungslink ist ungültig oder abgelaufen."),
        ...
        ["Numer protokołu jest wymagany."] = ("The protocol number is required.", "El número de protocolo es obligatorio.", "Die Protokollnummer ist erforderlich."),
