...
public static class ErrorMessageTranslator
{
    ...
    private static readonly Dictionary<string, Localized> Exact = new()
    {
        ...
        ["Kod może zawierać 3-20 wielkich liter/cyfr/myślników, bez spacji i bez znaków specjalnych."] = new("The code may contain 3-20 uppercase letters/digits/hyphens, with no spaces and no special characters.", "El código puede contener entre 3 y 20 letras mayúsculas, dígitos o guiones, sin espacios ni caracteres especiales.", "Der Code darf 3-20 Großbuchstaben/Ziffern/Bindestriche enthalten, ohne Leerzeichen und Sonderzeichen."),
