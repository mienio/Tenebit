...
public static class ErrorMessageTranslator
{
    ...
    {
        ["Aby przejść na plan Pro, użyj płatności Paddle (checkout)."] = new("To move to the Pro plan, use Paddle checkout.", "Para pasar al plan Pro, usa el pago con Paddle (checkout).", "Um auf den Pro-Plan zu wechseln, nutzen Sie den Paddle-Checkout.", "Per passare al piano Pro, usa il checkout Paddle.", "Pour passer au forfait Pro, utilisez le paiement Paddle (checkout)."),
        ...
        ["Nieobsługiwany kod waluty."] = new("Unsupported currency code.", "Código de moneda no admitido.", "Nicht unterstützter Währungscode.", "Codice valuta non supportato.", "Code de devise non pris en charge."),
        ["Data zakupu nie może być z przyszłości."] = new("The purchase date cannot be in the future.", "La fecha de compra no puede ser futura.", "Das Kaufdatum darf nicht in der Zukunft liegen.", "La data di acquisto non può essere futura.", "La date d'achat ne peut pas être dans le futur."),
        ["Gwarancja nie może kończyć się przed datą zakupu."] = new("The warranty cannot end before the purchase date.", "La garantía no puede terminar antes de la fecha de compra.", "Die Garantie darf nicht vor dem Kaufdatum enden.", "La garanzia non può terminare prima della data di acquisto.", "La garantie ne peut pas se terminer avant la date d'achat."),
        ...
        ["Kampania nie ma odbiorców ani sprzętu do potwierdzenia. Zmień zakres kampanii."] = new("The campaign has no recipients and no assets to confirm. Change the campaign scope.", "La campaña no tiene destinatarios ni activos que confirmar. Cambia el alcance de la campaña.", "Die Kampagne hat weder Empfänger noch zu bestätigende Assets. Ändern Sie den Kampagnenumfang.", "La campagna non ha destinatari né asset da confermare. Modifica l'ambito della campagna.", "La campagne n'a ni destinataires ni actifs à confirmer. Modifiez son périmètre."),
        ["Przypomnienia można wysyłać tylko w trwającej kampanii."] = new("Reminders can only be sent while the campaign is running.", "Los recordatorios solo pueden enviarse mientras la campaña está en curso.", "Erinnerungen können nur während einer laufenden Kampagne gesendet werden.", "I promemoria possono essere inviati solo durante una campagna in corso.", "Les rappels ne peuvent être envoyés que pendant une campagne en cours."),
        ...
        ["Nie można usunąć procedury powiązanej z zestawem stanowiskowym lub wydaniem pracownikowi. Usuń najpierw te powiązania."] = new("A procedure linked to a job profile or an assignment to an employee cannot be deleted. Remove those links first.", "No se puede eliminar un procedimiento vinculado a un perfil de puesto o a una entrega a un empleado. Elimina antes esos vínculos.", "Eine Prozedur, die mit einem Stellenprofil oder einer Mitarbeiterübergabe verknüpft ist, kann nicht gelöscht werden. Entfernen Sie zuerst diese Verknüpfungen.", "Una procedura collegata a un profilo professionale o a un'assegnazione a un dipendente non può essere eliminata. Rimuovi prima questi collegamenti.", "Une procédure liée à un profil de poste ou à une remise à un employé ne peut pas être supprimée. Supprimez d'abord ces liens."),
        ...
        ["Nieprawidłowy podpis webhooka Paddle."] = new("Invalid Paddle webhook signature.", "Firma de webhook de Paddle no válida.", "Ungültige Paddle-Webhook-Signatur.", "Firma del webhook Paddle non valida.", "Signature du webhook Paddle invalide."),
        ...
        ["Organizacja nie ma jeszcze konta rozliczeniowego Paddle."] = new("The organization does not yet have a Paddle billing account.", "La organización aún no tiene una cuenta de facturación de Paddle.", "Die Organisation verfügt noch über kein Paddle-Abrechnungskonto.", "L'organizzazione non dispone ancora di un account di fatturazione Paddle.", "L'organisation ne dispose pas encore de compte de facturation Paddle."),
        ...
        ["Płatności Paddle nie są jeszcze skonfigurowane."] = new("Paddle payments are not configured yet.", "Los pagos con Paddle aún no están configurados.", "Paddle-Zahlungen sind noch nicht konfiguriert.", "I pagamenti Paddle non sono ancora configurati.", "Les paiements Paddle ne sont pas encore configurés."),
        ...
        ["Ta organizacja ma aktywną płatną subskrypcję. Zarządzaj nią (w tym anulowaniem) w portalu rozliczeń Paddle."] = new("This organization has an active paid subscription. Manage it (including cancellation) in the Paddle billing portal.", "Esta organización tiene una suscripción de pago activa. Gestiónala (incluida la cancelación) en el portal de facturación de Paddle.", "Diese Organisation hat ein aktives kostenpflichtiges Abonnement. Verwalten Sie es (einschließlich Kündigung) im Paddle-Abrechnungsportal.", "Questa organizzazione ha un abbonamento a pagamento attivo. Gestiscilo (anche per la cancellazione) nel portale di fatturazione Paddle.", "Cette organisation dispose d'un abonnement payant actif. Gérez-le (y compris son annulation) dans le portail de facturation Paddle."),
        ...
        // --- Kody promocyjne ---
        ["Kod promocyjny nie może być pusty."] = new("The promo code cannot be empty.", "El código promocional no puede estar vacío.", "Der Aktionscode darf nicht leer sein.", "Il codice promozionale non può essere vuoto.", "Le code promo ne peut pas être vide."),
        ["Nieprawidłowy plan dla kodu promocyjnego."] = new("Invalid plan for this promo code.", "Plan no válido para este código promocional.", "Ungültiger Plan für diesen Aktionscode.", "Piano non valido per questo codice promozionale.", "Forfait invalide pour ce code promo."),
        ["Zniżka procentowa musi być w zakresie 1-100."] = new("The percentage discount must be between 1 and 100.", "El descuento porcentual debe estar entre 1 y 100.", "Der Prozentrabatt muss zwischen 1 und 100 liegen.", "Lo sconto percentuale deve essere compreso tra 1 e 100.", "La réduction en pourcentage doit être comprise entre 1 et 100."),
        ["Zniżka kwotowa musi być większa od zera."] = new("The fixed discount amount must be greater than zero.", "El importe fijo del descuento debe ser mayor que cero.", "Der feste Rabattbetrag muss größer als null sein.", "L'importo fisso dello sconto deve essere maggiore di zero.", "Le montant fixe de la réduction doit être supérieur à zéro."),
        ["Limit użyć musi być większy od zera."] = new("The redemption limit must be greater than zero.", "El límite de usos debe ser mayor que cero.", "Das Einlösungslimit muss größer als null sein.", "Il limite di utilizzo deve essere maggiore di zero.", "La limite d'utilisation doit être supérieure à zéro."),
        ["Liczba miesięcy zniżki musi być większa od zera."] = new("The discount duration in months must be greater than zero.", "La duración del descuento en meses debe ser mayor que cero.", "Die Rabattdauer in Monaten muss größer als null sein.", "La durata dello sconto in mesi deve essere maggiore di zero.", "La durée de la réduction en mois doit être supérieure à zéro."),
        ["Liczba miesięcy dotyczy tylko zniżki na określoną liczbę miesięcy."] = new("The number of months only applies to a discount with a fixed number of months.", "El número de meses solo se aplica a un descuento con una duración fija en meses.", "Die Anzahl der Monate gilt nur für einen Rabatt mit einer festen Monatsanzahl.", "Il numero di mesi si applica solo a uno sconto con una durata fissa in mesi.", "Le nombre de mois ne s'applique qu'à une réduction d'une durée fixe en mois."),
        ["Taki kod już istnieje."] = new("This code already exists.", "Este código ya existe.", "Dieser Code existiert bereits.", "Questo codice esiste già.", "Ce code existe déjà."),
        ["Kod nie istnieje."] = new("The code does not exist.", "El código no existe.", "Der Code existiert nicht.", "Il codice non esiste.", "Le code n'existe pas."),
        ["Nie udało się wygenerować unikalnego kodu, spróbuj ponownie."] = new("Could not generate a unique code, please try again.", "No se pudo generar un código único, inténtalo de nuevo.", "Es konnte kein eindeutiger Code erzeugt werden, bitte versuchen Sie es erneut.", "Non è stato possibile generare un codice univoco, riprova.", "Impossible de générer un code unique, veuillez réessayer."),
        ["Kod promocyjny jest nieprawidłowy lub wygasł."] = new("The promo code is invalid or has expired.", "El código promocional no es válido o ha caducado.", "Der Aktionscode ist ungültig oder abgelaufen.", "Il codice promozionale non è valido o è scaduto.", "Le code promo est invalide ou a expiré."),
        ["Ten kod obniża cenę poniżej minimalnej kwoty transakcji akceptowanej przez Paddle. Użyj kodu z mniejszą zniżką."] = new("This code reduces the price below the minimum transaction amount accepted by Paddle. Use a code with a smaller discount.", "Este código reduce el precio por debajo del importe mínimo de transacción aceptado por Paddle. Usa un código con un descuento menor.", "Dieser Code senkt den Preis unter den von Paddle akzeptierten Mindesttransaktionsbetrag. Verwenden Sie einen Code mit einem kleineren Rabatt.", "Questo codice riduce il prezzo al di sotto dell'importo minimo di transazione accettato da Paddle. Usa un codice con uno sconto inferiore.", "Ce code réduit le prix en dessous du montant minimum de transaction accepté par Paddle. Utilisez un code avec une remise plus faible."),

        // --- Dane do faktury (VAT ID) ---
        ["VAT ID ma nieprawidłową długość."] = new("The VAT ID has an invalid length.", "El VAT ID tiene una longitud no válida.", "Die VAT ID hat eine ungültige Länge.", "Il VAT ID ha una lunghezza non valida.", "Le VAT ID a une longueur invalide."),
        ["Kraj do faktury podaj jako dwuliterowy kod ISO, np. PL."] = new("Enter the invoicing country as a two-letter ISO code, e.g. PL.", "Introduce el país de facturación como código ISO de dos letras, p. ej. PL.", "Geben Sie das Rechnungsland als zweistelligen ISO-Code an, z. B. PL.", "Inserisci il paese di fatturazione come codice ISO a due lettere, ad es. PL.", "Indiquez le pays de facturation sous forme de code ISO à deux lettres, par ex. PL."),
        ["Nie udało się pobrać faktur z Paddle. Spróbuj ponownie za chwilę."] = new("The invoices could not be fetched from Paddle. Please try again in a moment.", "No se han podido obtener las facturas de Paddle. Inténtalo de nuevo en unos instantes.", "Die Rechnungen konnten nicht von Paddle abgerufen werden. Bitte versuchen Sie es gleich noch einmal.", "Non è stato possibile scaricare le fatture da Paddle. Riprova tra un momento.", "Les factures n'ont pas pu être récupérées depuis Paddle. Réessayez dans un instant."),
        ...
        ["Można usunąć wyłącznie szkic procedury. Opublikowaną lub zarchiwizowaną procedurę zarchiwizuj i utwórz nową wersję."] = new("Only a draft procedure can be deleted. Archive a published or archived procedure and create a new version.", "Solo se puede eliminar un borrador de procedimiento. Archiva un procedimiento publicado o archivado y crea una nueva versión.", "Nur ein Prozedurentwurf kann gelöscht werden. Archivieren Sie eine veröffentlichte oder archivierte Prozedur und erstellen Sie eine neue Version.", "È possibile eliminare solo una bozza di procedura. Archivia una procedura pubblicata o archiviata e crea una nuova versione.", "Seul un brouillon de procédure peut être supprimé. Archivez une procédure publiée ou archivée et créez une nouvelle version."),
        ...
        ["Stanowisko licencji można przypisać tylko aktywnej osobie."] = new("A license seat can only be assigned to an active person.", "Una plaza de licencia solo puede asignarse a una persona activa.", "Ein Lizenzplatz kann nur einer aktiven Person zugewiesen werden.", "Un posto di licenza può essere assegnato solo a una persona attiva.", "Une place de licence ne peut être attribuée qu'à une personne active."),
        ...
        // --- Subskrypcje ---
        ["Płatności Paddle nie są jeszcze skonfigurowane dla tego planu."] = new("Paddle payments are not configured for this plan yet.", "Los pagos con Paddle aún no están configurados para este plan.", "Paddle-Zahlungen sind für diesen Plan noch nicht konfiguriert.", "I pagamenti Paddle non sono ancora configurati per questo piano.", "Les paiements Paddle ne sont pas encore configurés pour ce forfait."),
        ["Istnieje subskrypcja Paddle wymagająca naprawy lub zarządzania. Użyj portalu rozliczeniowego zamiast tworzyć drugą subskrypcję."] = new("There is a Paddle subscription that needs repair or management. Use the billing portal instead of creating a second subscription.", "Existe una suscripción de Paddle que requiere reparación o gestión. Usa el portal de facturación en lugar de crear una segunda suscripción.", "Es besteht ein Paddle-Abonnement, das repariert oder verwaltet werden muss. Nutzen Sie das Abrechnungsportal, statt ein zweites Abonnement anzulegen.", "Esiste un abbonamento Paddle che richiede correzione o gestione. Usa il portale di fatturazione invece di creare un secondo abbonamento.", "Un abonnement Paddle nécessite une réparation ou une gestion. Utilisez le portail de facturation au lieu de créer un second abonnement."),
        ["Nieprawidłowy webhook Paddle."] = new("Invalid Paddle webhook.", "Webhook de Paddle no válido.", "Ungültiger Paddle-Webhook.", "Webhook Paddle non valido.", "Webhook Paddle invalide."),
        ["Brak aktywnej subskrypcji Paddle do zmiany - najpierw ją załóż przez płatność."] = new("There is no active Paddle subscription to change - set one up with a payment first.", "No hay una suscripción de Paddle activa para cambiar: primero configúrala con un pago.", "Es gibt kein aktives Paddle-Abonnement zum Ändern - richten Sie zuerst eines per Zahlung ein.", "Non c'è un abbonamento Paddle attivo da modificare: configuralo prima con un pagamento.", "Il n'y a pas d'abonnement Paddle actif à modifier - configurez-en un d'abord avec un paiement."),
        ["Płatność za zmianę planu nie powiodła się. Sprawdź metodę płatności w portalu rozliczeniowym Paddle i spróbuj ponownie."] = new("The payment for the plan change failed. Check your payment method in the Paddle billing portal and try again.", "El pago por el cambio de plan ha fallado. Comprueba tu método de pago en el portal de facturación de Paddle e inténtalo de nuevo.", "Die Zahlung für den Tarifwechsel ist fehlgeschlagen. Überprüfen Sie Ihre Zahlungsmethode im Paddle-Abrechnungsportal und versuchen Sie es erneut.", "Il pagamento per il cambio di piano non è riuscito. Controlla il metodo di pagamento nel portale di fatturazione Paddle e riprova.", "Le paiement du changement de forfait a échoué. Vérifiez votre moyen de paiement dans le portail de facturation Paddle et réessayez."),
        ["Nie udało się zaplanować zmiany planu. Spróbuj ponownie później."] = new("Could not schedule the plan change. Please try again later.", "No se ha podido programar el cambio de plan. Inténtalo de nuevo más tarde.", "Der Tarifwechsel konnte nicht geplant werden. Bitte versuchen Sie es später erneut.", "Non è stato possibile pianificare il cambio di piano. Riprova più tardi.", "Impossible de planifier le changement de forfait. Réessayez plus tard."),
        ["Brak zaplanowanej zmiany planu do anulowania."] = new("There is no scheduled plan change to cancel.", "No hay ningún cambio de plan programado que cancelar.", "Es gibt keinen geplanten Tarifwechsel zum Stornieren.", "Non c'è nessun cambio di piano programmato da annullare.", "Il n'y a aucun changement de forfait planifié à annuler."),
        ["Nie udało się anulować zaplanowanej zmiany planu. Spróbuj ponownie później."] = new("Could not cancel the scheduled plan change. Please try again later.", "No se ha podido cancelar el cambio de plan programado. Inténtalo de nuevo más tarde.", "Der geplante Tarifwechsel konnte nicht storniert werden. Bitte versuchen Sie es später erneut.", "Non è stato possibile annullare il cambio di piano programmato. Riprova più tardi.", "Impossible d'annuler le changement de forfait planifié. Réessayez plus tard."),
        ...
        ["Weryfikacja \"nie jestem robotem\" nie powiodła się. Spróbuj ponownie."] = new("The \"I'm not a robot\" check failed. Please try again.", "La verificación \"no soy un robot\" ha fallado. Inténtalo de nuevo.", "Die \"Ich bin kein Roboter\"-Prüfung ist fehlgeschlagen. Bitte versuche es erneut.", "La verifica \"non sono un robot\" non è riuscita. Riprova.", "La vérification \"Je ne suis pas un robot\" a échoué. Veuillez réessayer."),
        ...
        // Affiliate program (spec/AFFILIATE_PROGRAM_PLAN.md) - Tenebit.Domain/Affiliates/** and
        // Tenebit.Application/{Affiliates,Admin}/Affiliate*.cs.
        ["Kod kraju musi być dwuliterowym kodem ISO 3166-1."] = new("The country code must be a two-letter ISO 3166-1 code.", "El código de país debe ser un código ISO 3166-1 de dos letras.", "Der Ländercode muss ein zweistelliger ISO-3166-1-Code sein."),
        ["Liczba miesięcy zniżki musi być większa od zera, jeśli podana."] = new("The discount duration in months must be greater than zero when provided.", "La duración del descuento en meses debe ser mayor que cero si se indica.", "Die Rabattdauer in Monaten muss größer als null sein, sofern angegeben."),
        ["Kwoty transakcji nie mogą być ujemne - użyj CreateRefundCompensation dla zwrotów."] = new("Transaction amounts cannot be negative - use CreateRefundCompensation for refunds.", "Los importes de la transacción no pueden ser negativos; usa CreateRefundCompensation para los reembolsos.", "Transaktionsbeträge dürfen nicht negativ sein - verwenden Sie für Rückerstattungen CreateRefundCompensation."),
        ["Prowizja musi być w zakresie 0-100%."] = new("The commission must be within the range 0-100%.", "La comisión debe estar en el rango 0-100%.", "Die Provision muss im Bereich 0-100 % liegen."),
        ["Kwota zwrotu musi być większa od zera."] = new("The refund amount must be greater than zero.", "El importe del reembolso debe ser mayor que cero.", "Der Erstattungsbetrag muss größer als null sein."),
        ["Ta konwersja nie wymaga przeglądu."] = new("This conversion does not require review.", "Esta conversión no requiere revisión.", "Diese Conversion erfordert keine Überprüfung."),
        ["Konwersja wymaga przeglądu przed przypisaniem do okresu rozliczeniowego."] = new("The conversion requires review before it can be assigned to a payout period.", "La conversión requiere revisión antes de poder asignarla a un período de pago.", "Die Conversion muss erst überprüft werden, bevor sie einem Abrechnungszeitraum zugeordnet werden kann."),
        ["Temat wiadomości jest wymagany."] = new("A message subject is required.", "El asunto del mensaje es obligatorio.", "Der Betreff der Nachricht ist erforderlich."),
        ["Tylko otwarty okres można zamknąć."] = new("Only an open period can be closed.", "Solo se puede cerrar un período abierto.", "Nur ein offener Zeitraum kann geschlossen werden."),
        ["Nie można zamknąć okresu przed jego zakończeniem."] = new("The period cannot be closed before it has ended.", "El período no se puede cerrar antes de que finalice.", "Der Zeitraum kann nicht geschlossen werden, bevor er beendet ist."),
        ["Tylko okres oczekujący na wypłatę może zostać oznaczony jako opłacony."] = new("Only a period awaiting payout can be marked as paid.", "Solo un período pendiente de pago se puede marcar como pagado.", "Nur ein auf Auszahlung wartender Zeitraum kann als bezahlt markiert werden."),
        ["Okno prowizyjne w miesiącach musi być większe od zera."] = new("The commission window in months must be greater than zero.", "La ventana de comisión en meses debe ser mayor que cero.", "Das Provisionsfenster in Monaten muss größer als null sein."),
        ["Domyślny limit kodów musi być większy od zera."] = new("The default code limit must be greater than zero.", "El límite de códigos predeterminado debe ser mayor que cero.", "Das Standard-Codelimit muss größer als null sein."),
        ["Dzień wypłaty musi być w zakresie 1-28 (żeby istniał w każdym miesiącu)."] = new("The payout day must be within the range 1-28 (so it exists in every month).", "El día de pago debe estar en el rango 1-28 (para que exista en todos los meses).", "Der Auszahlungstag muss im Bereich 1-28 liegen (damit er in jedem Monat existiert)."),
        ["Liczba dni poślizgu musi być w zakresie 0-28."] = new("The grace period in days must be within the range 0-28.", "El margen en días debe estar en el rango 0-28.", "Die Kulanzfrist in Tagen muss im Bereich 0-28 liegen."),
        ["Minimalna kwota wypłaty nie może być ujemna."] = new("The minimum payout amount cannot be negative.", "El importe mínimo de pago no puede ser negativo.", "Der Mindestauszahlungsbetrag darf nicht negativ sein."),
        ["Kwota wypłaty musi być większa od zera."] = new("The payout amount must be greater than zero.", "El importe del pago debe ser mayor que cero.", "Der Auszahlungsbetrag muss größer als null sein."),
        ["Wypłata musi obejmować co najmniej jeden okres rozliczeniowy."] = new("A payout must cover at least one payout period.", "Un pago debe cubrir al menos un período de pago.", "Eine Auszahlung muss mindestens einen Abrechnungszeitraum abdecken."),
        ["Kod afiliacyjny nie może być pusty."] = new("The affiliate code cannot be empty.", "El código de afiliado no puede estar vacío.", "Der Affiliate-Code darf nicht leer sein."),
        ["Kod może zawierać 7-20 wielkich liter/cyfr/myślników, bez spacji i bez znaków specjalnych."] = new("The code may contain 7-20 uppercase letters/digits/hyphens, with no spaces and no special characters.", "El código puede contener entre 7 y 20 letras mayúsculas, dígitos o guiones, sin espacios ni caracteres especiales.", "Der Code darf 7-20 Großbuchstaben/Ziffern/Bindestriche enthalten, ohne Leerzeichen und Sonderzeichen."),
        ["Ten kod jest zastrzeżony. Wybierz inny."] = new("This code is reserved. Choose another one.", "Este código está reservado. Elige otro.", "Dieser Code ist reserviert. Wählen Sie einen anderen."),
        ["Hasło jest wymagane."] = new("A password is required.", "Se requiere una contraseña.", "Ein Passwort ist erforderlich."),
        ["Revtag Revolut musi mieć postać @nazwa (2-32 znaki: litery, cyfry, kropka, podkreślnik)."] = new("The Revolut revtag must look like @name (2-32 characters: letters, digits, dot, underscore).", "El revtag de Revolut debe tener el formato @nombre (2-32 caracteres: letras, dígitos, punto, guion bajo).", "Der Revolut-Revtag muss die Form @name haben (2-32 Zeichen: Buchstaben, Ziffern, Punkt, Unterstrich)."),
        ["Adres e-mail PayPal jest nieprawidłowy."] = new("The PayPal e-mail address is invalid.", "La dirección de correo de PayPal no es válida.", "Die PayPal-E-Mail-Adresse ist ungültig."),
        ["Można reaktywować tylko zablokowane konto."] = new("Only a blocked account can be reactivated.", "Solo se puede reactivar una cuenta bloqueada.", "Nur ein gesperrtes Konto kann reaktiviert werden."),
        ["Limit aktywnych kodów musi być większy od zera."] = new("The active code limit must be greater than zero.", "El límite de códigos activos debe ser mayor que cero.", "Das Limit für aktive Codes muss größer als null sein."),
        ["Domyślna zniżka dla klienta musi być w zakresie 1-100%, jeśli kod ma dawać zniżkę."] = new("The default customer discount must be within the range 1-100% when a code is set to grant a discount.", "El descuento predeterminado para el cliente debe estar en el rango 1-100% si el código debe dar un descuento.", "Der Standard-Kundenrabatt muss im Bereich 1-100 % liegen, wenn der Code einen Rabatt gewähren soll."),
        ["Liczba miesięcy domyślnej zniżki dla klienta musi być większa od zera, jeśli podana."] = new("The default customer discount duration in months must be greater than zero when provided.", "La duración predeterminada del descuento para el cliente en meses debe ser mayor que cero si se indica.", "Die Standarddauer des Kundenrabatts in Monaten muss größer als null sein, sofern angegeben."),
        ["Treść wiadomości jest wymagana."] = new("The message body is required.", "El contenido del mensaje es obligatorio.", "Der Nachrichtentext ist erforderlich."),
        ["Jeden lub więcej wskazanych okresów nie oczekuje już na wypłatę."] = new("One or more of the specified periods is no longer awaiting payout.", "Uno o más de los períodos indicados ya no está pendiente de pago.", "Einer oder mehrere der angegebenen Zeiträume warten nicht mehr auf Auszahlung."),
        ["Reguła nie istnieje."] = new("The rule does not exist.", "La regla no existe.", "Die Regel existiert nicht."),
        ["To konto partnerskie zostało zablokowane."] = new("This partner account has been blocked.", "Esta cuenta de partner ha sido bloqueada.", "Dieses Partnerkonto wurde gesperrt."),
        ["Potwierdź adres e-mail przed zalogowaniem."] = new("Confirm your e-mail address before logging in.", "Confirma tu dirección de correo antes de iniciar sesión.", "Bestätigen Sie Ihre E-Mail-Adresse, bevor Sie sich anmelden."),
        ["Ten kod jest już zajęty."] = new("This code is already taken.", "Este código ya está en uso.", "Dieser Code ist bereits vergeben."),
        ["Wątek nie istnieje."] = new("The thread does not exist.", "El hilo no existe.", "Der Thread existiert nicht."),
        ["Konto partnerskie nie istnieje."] = new("The partner account does not exist.", "La cuenta de partner no existe.", "Das Partnerkonto existiert nicht."),
        ["Afiliant nie istnieje."] = new("The affiliate does not exist.", "El afiliado no existe.", "Der Affiliate existiert nicht."),
        ["Akceptacja regulaminu programu partnerskiego jest wymagana."] = new("Acceptance of the affiliate program terms is required.", "Es obligatorio aceptar las condiciones del programa de afiliados.", "Die Annahme der Partnerprogramm-Bedingungen ist erforderlich."),
        ["Poprawny e-mail jest wymagany."] = new("A valid e-mail address is required.", "Se requiere una dirección de correo válida.", "Eine gültige E-Mail-Adresse ist erforderlich."),
        ["Wersja regulaminu jest wymagana."] = new("A terms-of-service version is required.", "Se requiere una versión de las condiciones de uso.", "Eine Version der Nutzungsbedingungen ist erforderlich."),
        ["Konto zablokowane - najpierw je odblokuj (Reactivate), zanim zatwierdzisz ponownie."] = new("The account is blocked - reactivate it first before approving it again.", "La cuenta está bloqueada; reactívala antes de volver a aprobarla.", "Das Konto ist gesperrt - reaktivieren Sie es zuerst, bevor Sie es erneut genehmigen."),
        ["Powód blokady jest wymagany."] = new("A block reason is required.", "Se requiere un motivo de bloqueo.", "Ein Sperrgrund ist erforderlich."),
    };
    ...
    private static readonly List<TemplateRule> Templates = new()
    {
        ...
        new TemplateRule(
            new Regex(@"^Aby przejść na plan (?<plan>.+), użyj płatności Paddle \(checkout\)\.$"),
            (m, lang) => lang switch
            {
                "en" => $"To move to the {m.Groups["plan"].Value} plan, use Paddle checkout.",
                "es" => $"Para pasar al plan {m.Groups["plan"].Value}, usa el pago con Paddle (checkout).",
                "de" => $"Um auf den {m.Groups["plan"].Value}-Plan zu wechseln, nutzen Sie den Paddle-Checkout.",
                "it" => $"Per passare al piano {m.Groups["plan"].Value}, usa il checkout Paddle.",
                "fr" => $"Pour passer au forfait {m.Groups["plan"].Value}, utilisez le paiement Paddle (checkout).",
                _ => null,
            }),
        new TemplateRule(
