...
[ValidatedRequest]
public sealed record ReturnAssignmentAssetRequest(Guid AssetId, string? ReturnCondition, ReturnState? ReturnState = null);
[ValidatedRequest]
...
[ValidatedRequest]
public sealed record ReturnAssignmentAssetItemRequest(ReturnResolution Resolution, string? ReturnCondition, string? ReturnLocation, string? Notes, ReturnState? ReturnState = null);
...
public sealed record AssignmentAssetResponse(Guid AssetId, string? AssetName, string? AssetTag, string IssueCondition, string? ReturnCondition, DateTimeOffset? ReturnedAt, string? ReturnLocation, string? ReturnedBy, ReturnResolution? ReturnResolution, string? ReturnNotes, ReturnState? ReturnState = null);
