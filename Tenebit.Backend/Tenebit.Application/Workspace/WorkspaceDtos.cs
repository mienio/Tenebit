...
public sealed record MyAssetResponse(Guid Id, string Name, string AssetTag, string? CategoryName, string? CategoryIcon, string? Location, DateOnly? WarrantyUntil);
