    ...
    string Page)
{
    private static readonly ProtocolLabels Polish = new(
        ...
        Signature: "Podpis pracownika",
        SignatureMissing: "Potwierdzono bez podpisu odręcznego.",
    ...
    private static readonly ProtocolLabels English = new(
        ...
        SignatureMissing: "Confirmed without a drawn signature.",
    ...
    private static readonly ProtocolLabels Spanish = new(
        ...
        Signature: "Firma del empleado",
        SignatureMissing: "Confirmado sin firma manuscrita.",
    ...
    private static readonly ProtocolLabels German = new(
        ...
        SignatureMissing: "Ohne handschriftliche Unterschrift bestätigt.",
