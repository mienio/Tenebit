...
public sealed record OrganizationUserResponse(Guid Id, string Email, string DisplayName, bool IsActive, IReadOnlyList<string> Roles, DateTimeOffset CreatedAt, Guid? PersonId);
[ValidatedRequest]
