        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Limit liczby aktywów określony dla danego planu obowiązuje w tej samej wysokości dla liczby pracowników, lokalizacji i procedur przechowywanych w systemie w ramach organizacji. Przekroczenie limitu wymaga przejścia na wyższy plan.',
    ...
    documents: {
      ...
      terms: {
        title: 'Términos del servicio Tenebit', description: 'Reglas de uso del servicio de gestión de activos, personas, entregas y procedimientos.', sections: [
          ...
          { title: '4. Contrato y terminación', paragraphs: ['El contrato se celebra al crear la organización y aceptar los términos o mediante un pedido separado. Precio, impuestos, límites y renovación se muestran antes de comprar.', 'El límite de activos indicado para un plan se aplica igualmente al número de personas, ubicaciones y procedimientos almacenados en el sistema para esa organización. Superar el límite requiere pasar a un plan superior.', 'La organización puede terminar según la cuenta o el contrato. El operador puede resolver por incumplimiento grave, impago, abuso o riesgo de seguridad respetando el preaviso aplicable.'] },
