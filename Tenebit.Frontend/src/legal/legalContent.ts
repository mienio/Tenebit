        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              `W sprawach prywatności pisz na ${legalConfig.supportEmail}.`
            ]
          }
        ]
      },
      terms: {
        ...
        sections: [
          ...
          },
          {
            title: '8. Reklamacje',
            paragraphs: [
              `Reklamację można wysłać na ${legalConfig.supportEmail}. Należy podać organizację, opis problemu, datę wystąpienia i oczekiwany sposób rozwiązania. Operator odpowiada bez zbędnej zwłoki, co do zasady w ciągu 14 dni, chyba że szczególny przepis lub umowa przewiduje inny termin.`
            ]
          },
          {
    ...
    documents: {
      privacy: {
        title: 'Privacy policy', description: 'Information about personal data processing in Tenebit.', sections: [
          ...
          { title: '9. Security and contact', paragraphs: ['We apply technical and organizational measures proportionate to risk, including access controls, tenant separation, event logging, transport encryption and session revocation. No system can guarantee absolute security.', `Send privacy requests to ${legalConfig.supportEmail}.`] }
        ]
      },
      terms: {
        title: 'Tenebit terms of service', description: 'Rules for using the asset, people, handover and procedure management service.', sections: [
          ...
          { title: '8. Complaints', paragraphs: [`Send complaints to ${legalConfig.supportEmail}, with the organization, issue, date and requested resolution. The operator responds without undue delay, generally within 14 days unless a specific law or contract provides otherwise.`] },
    ...
    documents: {
      privacy: {
        title: 'Política de privacidad', description: 'Información sobre el tratamiento de datos personales en Tenebit.', sections: [
          ...
          { title: '9. Seguridad y contacto', paragraphs: ['Aplicamos medidas proporcionadas al riesgo, como control de acceso, separación entre organizaciones, registros, cifrado de transporte y revocación de sesiones. Ningún sistema ofrece seguridad absoluta.', `Envía las solicitudes de privacidad a ${legalConfig.supportEmail}.`] }
        ]
      },
      terms: {
        title: 'Términos del servicio Tenebit', description: 'Reglas de uso del servicio de gestión de activos, personas, entregas y procedimientos.', sections: [
          ...
          { title: '8. Reclamaciones', paragraphs: [`Envía la reclamación a ${legalConfig.supportEmail}, con organización, problema, fecha y solución esperada. Se responde sin demora indebida, normalmente en 14 días salvo norma o contrato distinto.`] },
    ...
    documents: {
      ...
      terms: {
        title: 'Tenebit Nutzungsbedingungen', description: 'Regeln für den Dienst zur Verwaltung von Assets, Personen, Übergaben und Verfahren.', sections: [
          ...
          { title: '8. Beschwerden', paragraphs: [`Beschwerden sind mit Organisation, Problem, Datum und gewünschter Lösung an ${legalConfig.supportEmail} zu senden. Die Antwort erfolgt unverzüglich, grundsätzlich binnen 14 Tagen, sofern Gesetz oder Vertrag nichts anderes bestimmen.`] },
    ...
    ui: {
      ...
      privacy: {
        title: 'Informativa sulla privacy', description: 'Informazioni sul trattamento dei dati personali in Tenebit.', sections: [
          ...
          { title: '9. Sicurezza e contatti', paragraphs: ['Applichiamo misure tecniche e organizzative proporzionate al rischio, tra cui controlli degli accessi, separazione dei tenant, registrazione degli eventi, cifratura in transito e revoca delle sessioni. Nessun sistema può garantire una sicurezza assoluta.', `Per le richieste in materia di privacy scrivi a ${legalConfig.supportEmail}.`] }
        ]
      },
      terms: {
        title: 'Termini di servizio di Tenebit', description: 'Regole di utilizzo del servizio di gestione di asset, persone, consegne e procedure.', sections: [
          ...
          { title: '8. Reclami', paragraphs: [`Invia i reclami a ${legalConfig.supportEmail}, precisando organizzazione, problema, data e soluzione richiesta. Il gestore risponde senza indebito ritardo, di norma entro 14 giorni, salvo diversa previsione di legge o di contratto.`] },
    ...
    ui: {
      ...
      terms: {
        title: 'Conditions générales de Tenebit', description: 'Règles d’utilisation du service de gestion des actifs, des personnes, des remises et des procédures.', sections: [
          ...
          { title: '8. Réclamations', paragraphs: [`Adressez vos réclamations à ${legalConfig.supportEmail}, en précisant l'organisation, le problème, la date et la solution demandée. L'exploitant répond sans retard injustifié, en principe sous 14 jours, sauf disposition légale ou contractuelle contraire.`] },
