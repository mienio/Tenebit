    ...
    ui: {
      ...
      cookies: {
        title: 'Cookie e archiviazione sul dispositivo', description: "Come Tenebit utilizza l'archiviazione del browser e quando è necessario il consenso.", sections: [
          { title: '1. Ambito attuale', paragraphs: ["La versione attuale di Tenebit non utilizza strumenti pubblicitari o di analisi. Il servizio impiega cookie tecnici, localStorage e sessionStorage per l'accesso, la sicurezza della sessione, le funzioni richieste e le preferenze di interfaccia."] },
          ...
          { title: '3. Consenso', paragraphs: ["Non è richiesto il consenso preventivo per l'archiviazione strettamente necessaria a trasmettere una comunicazione o a fornire una funzione espressamente richiesta dall'utente. Tenebit non presenta quindi una finta richiesta di consenso per analisi o pubblicità quando tali strumenti non sono in uso.", 'Eventuali futuri strumenti di analisi, pubblicità, profilazione o altra archiviazione non essenziale dovranno restare disattivati finché non sia raccolto un consenso libero e granulare, revocabile con la stessa facilità con cui è prestato.'] },
          { title: "4. Gestione dell'archiviazione", paragraphs: ["Puoi rimuovere o bloccare i cookie nelle impostazioni del browser. La rimozione dei dati tecnici può disconnetterti, azzerare le preferenze di lingua o di visualizzazione e disattivare alcune funzioni. Anche i fornitori di pagamento e di accesso tramite social possono utilizzare l'archiviazione secondo le proprie informative quando attivi tali integrazioni."] }
        ]
      }
      }
  },
    ...
    ui: {
      ...
      cookies: {
        title: "Cookies et stockage sur l'appareil", description: 'Comment Tenebit utilise le stockage du navigateur et quand le consentement est requis.', sections: [
          { title: '1. Périmètre actuel', paragraphs: ["La version actuelle de Tenebit n'utilise aucun outil publicitaire ou d'analyse. Le service emploie des cookies techniques, localStorage et sessionStorage pour la connexion, la sécurité de la session, les fonctions demandées et les préférences d'interface."] },
          ...
          { title: '3. Consentement', paragraphs: ["Le consentement préalable n'est pas requis pour le stockage strictement nécessaire à la transmission d'une communication ou à la fourniture d'une fonction expressément demandée par l'utilisateur. Tenebit ne présente donc pas de fausse demande de consentement analytique ou publicitaire lorsque ces outils ne sont pas utilisés.", "Tout futur outil d'analyse, de publicité, de profilage ou tout autre stockage non essentiel devra rester désactivé tant qu'un consentement libre et granulaire n'aura pas été recueilli, révocable aussi facilement qu'il est donné."] },
          { title: '4. Gestion du stockage', paragraphs: ["Vous pouvez supprimer ou bloquer les cookies dans les réglages de votre navigateur. La suppression des données techniques peut vous déconnecter, effacer vos préférences de langue ou d'affichage et désactiver certaines fonctions. Les prestataires de paiement et de connexion via les réseaux sociaux peuvent également utiliser le stockage selon leurs propres informations lorsque vous activez ces intégrations."] }
        ]
      }
      }
  }
