...
// Serwis nie wskazuje żadnego podmiotu prowadzącego: nie ma zarejestrowanej działalności, a dokumenty
// prawne odsyłają wyłącznie do adresu kontaktowego usługi. Dlatego nie ma tu pól na nazwę, adres ani
// numery rejestrowe - nie ma ich czym wypełnić i nie mają się pojawić.
